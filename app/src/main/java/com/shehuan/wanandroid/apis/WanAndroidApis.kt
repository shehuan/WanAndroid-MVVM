...
interface WanAndroidApis {
     ...
     */
    @GET("tree/json")
    fun tree(): Call<BaseResponse<List<TreeBean>>>

    /**
     * 体系下的文章
     */
    @GET("article/list/{pageNum}/json")
    fun treeDetail(@Path("pageNum") pageNum: Int, @Query("cid") cid: Int): Call<BaseResponse<TreeDetailBean>>
    ...
    fun uncollectArticle(@Path("id") id: Int): Call<BaseResponse<String>>
